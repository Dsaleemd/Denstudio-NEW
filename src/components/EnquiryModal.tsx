        ...
        <div ref={formContainerRef} className="w-full max-w-lg mx-auto px-6 pt-8 pb-20">
          ...
          <form className="space-y-5" onSubmit={(e) => { e.preventDefault(); }}>
            <div>
              ...
              <input id="eq-first-name" name="firstName" type="text" required
            ...
            <div>
              ...
              <input id="eq-last-name" name="lastName" type="text"
                className="w-full border-0 border-b-2 border-neutral-200 bg-transparent px-0 py-3 text-base text-neutral-900 placeholder:text-neutral-400 focus:border-[#012406] focus:ring-0 outline-none transition-colors"
            ...
            <div>
              ...
              <input id="eq-phone" name="phone" type="tel" required
                className="w-full border-0 border-b-2 border-neutral-200 bg-transparent px-0 py-3 text-base text-neutral-900 placeholder:text-neutral-400 focus:border-[#012406] focus:ring-0 outline-none transition-colors"
                placeholder="+44 7000 000000" />
            </div>
            <div className="flex items-start gap-3 pt-2">
              <input id="eq-privacy" name="privacy" type="checkbox" required
              ...
              <label htmlFor="eq-privacy" className="text-sm text-neutral-600">
                I agree to the{" "}
                <a href="/privacy-notice" target="_blank" rel="noopener noreferrer" className="underline hover:text-neutral-900">privacy policy</a>{" "}
                <span className="text-red-500">*</span>
              </label>
            </div>
            <div className="flex items-start gap-3">
              <input id="eq-marketing" name="marketing" type="checkbox"
                className="mt-0.5 h-4 w-4 rounded border-neutral-300 text-[#012406] focus:ring-[#012406]" />
