...
export default function Home() {
  return (
    <>
      {/* ── Section 1: Hero ── */}
      {/* Mobile: text top → image below → review pill overlaid at bottom */}
      {/* Desktop: full-bleed image with text bottom-left, pill bottom-right */}
      <section className="relative overflow-hidden">
        {/* ── MOBILE LAYOUT ── */}
        <div className="md:hidden">
          {/* Text block at top */}
          <div className="pt-28 pb-8 px-6 bg-[#faf9f7]">
            <h1 className="text-[2.6rem] font-semibold text-[#222222] leading-[1.05] mb-5">
              Redefining the future of aesthetic dentistry
            </h1>
            <p className="text-base text-[#444444] leading-relaxed mb-6">
          ...
          {/* Image fills rest of viewport with review pill at bottom */}
          <div className="relative aspect-[3/4]">
            <Image src="/images/homepage/hero/hero-banner.webp" alt="Denstudio aesthetic dentistry" fill className="object-cover object-top" priority />
            {/* Review pill anchored at bottom */}
            <div className="absolute bottom-6 left-4 right-4 z-10 flex justify-center">
              <div className="inline-flex items-center gap-2.5 bg-white/95 backdrop-blur-sm rounded-full px-4 py-2.5 shadow-lg">
                <span className="text-[11px] font-bold uppercase tracking-wide text-[#222222]">Excellent</span>
                <span className="text-[#fbbc04] text-sm leading-none">★★★★★</span>
                <span className="text-[11px] text-[#555555]">72 reviews</span>
                <svg className="h-3.5 w-auto" viewBox="0 0 272 92" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="hidden md:block relative min-h-screen">
          ...
          <div className="relative z-10 w-full h-screen flex flex-col justify-end px-12 lg:px-16 pb-16">
            <div className="max-w-7xl mx-auto w-full flex flex-row items-end justify-between gap-8">
              <div className="max-w-2xl">
                <h1 className="text-6xl lg:text-[5.5rem] font-semibold text-[#222222] leading-[1.05] mb-6">
                  Redefining the future of aesthetic dentistry
                </h1>
              ...
              <div className="flex-shrink-0">
                <div className="inline-flex items-center gap-3 bg-white/95 backdrop-blur-sm rounded-full px-5 py-3 shadow-lg">
                  <span className="text-xs font-bold uppercase tracking-wide text-[#222222]">Excellent</span>
                  <span className="text-[#fbbc04] text-base leading-none">★★★★★</span>
                  <span className="text-xs text-[#555555]">72 reviews</span>
                  <svg className="h-4 w-auto" viewBox="0 0 272 92" xmlns="http://www.w3.org/2000/svg">
                    <path d="M115.75 47.18c0 12.77-9.99 22.18-22.25 22.18s-22.25-9.41-22.25-22.18c0-12.86 9.99-22.18 22.25-22.18s22.25 9.32 22.25 22.18zm-9.74 0c0-7.98-5.79-13.44-12.51-13.44S80.99 39.2 80.99 47.18c0 7.9 5.79 13.44 12.51 13.44s12.51-5.55 12.51-13.44z" fill="#EA4335"/>
                    <path d="M163.75 47.18c0 12.77-9.99 22.18-22.25 22.18s-22.25-9.41-22.25-22.18c0-12.85 9.99-22.18 22.25-22.18s22.25 9.32 22.25 22.18zm-9.74 0c0-7.98-5.79-13.44-12.51-13.44s-12.51 5.46-12.51 13.44c0 7.9 5.79 13.44 12.51 13.44s12.51-5.55 12.51-13.44z" fill="#FBBC05"/>
                    <path d="M209.75 26.34v39.82c0 16.38-9.66 23.07-21.08 23.07-10.75 0-17.22-7.19-19.66-13.07l8.48-3.53c1.51 3.61 5.21 7.87 11.17 7.87 7.31 0 11.84-4.51 11.84-13v-3.19h-.34c-2.18 2.69-6.38 5.04-11.68 5.04-11.09 0-21.25-9.66-21.25-22.09 0-12.52 10.16-22.26 21.25-22.26 5.29 0 9.49 2.35 11.68 4.96h.34v-3.61h9.25zm-8.56 20.92c0-7.81-5.21-13.52-11.84-13.52-6.72 0-12.35 5.71-12.35 13.52 0 7.73 5.63 13.36 12.35 13.36 6.63 0 11.84-5.63 11.84-13.36z" fill="#4285F4"/>
                    <path d="M225 3v65h-9.5V3h9.5z" fill="#34A853"/>
