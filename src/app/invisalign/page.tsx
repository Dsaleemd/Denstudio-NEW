...
export const metadata: Metadata = {
  title: "Invisalign Harley Street | Free Consultation — DENSTUDIO",
  description:
    "Clear aligners at Denstudio Harley Street. Invisalign certified provider with price-match guarantee. Free consultation with Dr Jana Denzel. 0% finance available.",
};

const beforeAfterImages = [
  { src: "/images/veneers-landing/gallery/before-after-1.webp", alt: "Smile transformation — before and after" },
  { src: "/images/veneers-landing/gallery/before-after-3.webp", alt: "Teeth straightening — before and after" },
  { src: "/images/veneers-landing/gallery/before-after-5.webp", alt: "Invisalign results — before and after" },
];

const patientResults = [
  { src: "/images/veneers-landing/gallery/patient-result-2.webp", alt: "Invisalign patient result" },
  { src: "/images/veneers-landing/gallery/patient-result-3.webp", alt: "Smile transformation result" },
  { src: "/images/veneers-landing/gallery/patient-result-3b.webp", alt: "Teeth straightening result" },
  { src: "/images/veneers-landing/gallery/patient-result-5.webp", alt: "Clear aligner patient result" },
  { src: "/images/veneers-landing/gallery/patient-result-7.webp", alt: "Invisalign smile makeover" },
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-10 lg:items-stretch">
            ...
            <div className="flex flex-col text-white">
              ...
              <div className="flex flex-wrap gap-3 mb-6">
                ...
                <span className="inline-block text-xs font-medium bg-white/15 backdrop-blur-sm px-3 py-1.5 rounded-full">Invisalign Certified</span>
              </div>

              <h1 className="text-4xl md:text-5xl lg:text-[3.5rem] font-bold leading-[1.08] mb-5">
                Invisible Braces That Actually Work
              </h1>

              <p className="text-white/80 text-lg leading-relaxed mb-6 max-w-lg">
                Straighten your teeth discreetly with Invisalign at our Harley Street clinic. Custom-designed clear aligners that fit your lifestyle &mdash; no metal, no wires, no compromise.
              </p>
              ...
              <div className="flex flex-wrap gap-x-6 gap-y-3 mb-8">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm text-white/70">Invisalign certified provider</span>
                </div>
                <div className="flex items-center gap-2">
                ...
                <form className="space-y-3">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    ...
                    <select className="w-full px-4 py-3 rounded-xl border border-[#ddd] text-sm text-[#555] focus:outline-none focus:border-[#012406] focus:ring-1 focus:ring-[#012406]/20 transition-all">
                      <option>Treatment timeline?</option>
            ...
            <div className="relative rounded-2xl overflow-hidden min-h-[400px] lg:min-h-0">
              <Image src="/images/teeth-straightening/hero.webp" alt="Invisalign clear aligners at DENSTUDIO Harley Street" fill className="object-cover object-center" priority />
            </div>
      ...
      <section className="py-20 md:py-28 bg-[#f8f8f6]">
        <div className="mx-auto max-w-7xl px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              <p className="text-xs uppercase tracking-[0.2em] text-[#555555] mb-3">Your Invisalign Provider</p>
              ...
              <div className="space-y-3 mb-8">
                {[
                  "Invisalign certified provider with 100+ cases completed",
                  "Price match guarantee — we beat any UK quote",
                  "Combines aligners with bonding for complete smile makeovers",
      ...
      <section className="py-20 md:py-28">
        <div className="mx-auto max-w-7xl px-6">
          ...
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-light text-[#222222] leading-[1.15] mb-12 text-center">
            Your 4-Step Smile Plan
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              { step: "01", title: "Free Consultation", description: "Digital 3D scan of your teeth. Dr Denzel designs your custom treatment plan and shows you a preview of your final result." },
              { step: "02", title: "Custom Aligners", description: "Your bespoke aligners are fabricated using precision digital moulds. Each set gradually shifts your teeth into the perfect position." },
              { step: "03", title: "Wear & Monitor", description: "Wear your aligners 20-22 hours daily. Swap to the next set every 1-2 weeks. Quick check-ups every 6-8 weeks." },
              { step: "04", title: "Your New Smile", description: "Treatment complete. Vivera retainers keep your teeth in their new position. Enjoy your confident, straight smile." },
            ].map((item) => (
      ...
      <section className="py-20 md:py-28">
        <div className="mx-auto max-w-7xl px-6">
          ...
          <p className="text-[#555555] text-center mb-12 max-w-2xl mx-auto">
            Transparent pricing with no hidden costs. 0% finance available. Price match guarantee &mdash; we&apos;ll beat any like-for-like UK quote.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto">
            ...
            <div className="bg-white rounded-2xl p-8 border border-[#e5e5e5] flex flex-col">
              ...
              <p className="text-sm text-[#555555] mb-4">Mild cases &bull; 3-6 months</p>
              <span className="text-4xl font-bold text-[#012406] mb-1">&pound;2,950</span>
              <span className="text-xs text-[#555] mb-4">Minor crowding or relapse</span>
              <ul className="space-y-2 text-sm text-[#555] flex-1 mb-6">
                <li className="flex items-start gap-2"><span className="text-[#012406] mt-0.5">&#10003;</span>Digital 3D scan</li>
                <li className="flex items-start gap-2"><span className="text-[#012406] mt-0.5">&#10003;</span>Up to 7 aligners</li>
                <li className="flex items-start gap-2"><span className="text-[#012406] mt-0.5">&#10003;</span>Monitoring appointments</li>
                <li className="flex items-start gap-2"><span className="text-[#012406] mt-0.5">&#10003;</span>Vivera retainers</li>
              </ul>
            ...
            <div className="bg-white rounded-2xl p-8 border-2 border-[#012406] flex flex-col relative">
              ...
              <p className="text-sm text-[#555555] mb-4">Moderate to complex &bull; 12-18 months</p>
              <span className="text-4xl font-bold text-[#012406] mb-1">From &pound;3,950</span>
              <span className="text-xs text-[#555] mb-4">Moderate to complex cases</span>
              <ul className="space-y-2 text-sm text-[#555] flex-1 mb-6">
                <li className="flex items-start gap-2"><span className="text-[#012406] mt-0.5">&#10003;</span>Digital 3D scan</li>
                <li className="flex items-start gap-2"><span className="text-[#012406] mt-0.5">&#10003;</span>All aligners included</li>
                <li className="flex items-start gap-2"><span className="text-[#012406] mt-0.5">&#10003;</span>Monitoring appointments</li>
                <li className="flex items-start gap-2"><span className="text-[#012406] mt-0.5">&#10003;</span>Vivera retainers</li>
              </ul>
            ...
            <div className="bg-white rounded-2xl p-8 border border-[#e5e5e5] flex flex-col">
              ...
              <span className="text-sm text-[#999999] line-through">Was &pound;7,580</span>
              <span className="text-4xl font-bold text-[#012406] mb-1">&pound;3,790</span>
              <span className="text-xs text-[#C4A574] font-semibold mb-4">Save &pound;3,790 &mdash; complete transformation</span>
              <ul className="space-y-2 text-sm text-[#555] flex-1 mb-6">
                <li className="flex items-start gap-2"><span className="text-[#012406] mt-0.5">&#10003;</span>Full Invisalign treatment</li>
          ...
          <p className="text-center text-sm text-[#555] mt-8">
            0% finance available on all packages. Price match guarantee on all Invisalign treatments. <Link href="/fees" className="text-[#012406] font-medium underline">View full fee list</Link>
          </p>
        </div>
      </section>
      ...
      <section className="py-20 md:py-28 bg-[#012406] text-white text-center">
        <div className="mx-auto max-w-3xl px-6">
          ...
          <p className="text-white/80 leading-relaxed mb-4 text-lg">
            Book your free Invisalign consultation at our Harley Street practice today. See your predicted results before you commit.
          </p>
